    ...
    <section id="inicio" className="py-20 px-4">
      <div className="container mx-auto text-center">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-red-600 via-red-700 to-red-800 bg-clip-text text-transparent">
            JUSC
          </h1>
          <p className="text-xl md:text-2xl text-gray-600 mb-8 leading-relaxed">Juventude Unida pelo Sagrado Coração</p>
